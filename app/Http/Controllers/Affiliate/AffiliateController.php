...
class AffiliateController extends Controller
{
     ...
     *              @OA\Property(property="degree_id", type="integer", description="id del grado policial", example=3),
     ...
     *              @OA\Property(property="civil_status", type="string", description="estado civil", example="S"),
     *              @OA\Property(property="birth_date", type="date", description="fecha de nacimiento", example="1998-07-01"),
