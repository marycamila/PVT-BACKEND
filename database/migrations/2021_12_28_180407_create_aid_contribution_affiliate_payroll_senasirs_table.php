...
class CreateAidContributionAffiliatePayrollSenasirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aid_contribution_affiliate_payroll_senasirs', function (Blueprint $table) {
            $table->id();
